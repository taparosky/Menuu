...
namespace Menuu.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class AdminSnacksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SnackId,SnackName,ShortDescription,LongDescription,Price,ImageUrl,ImageThumbUrl,IsFavorite,InStock,CategoryId")] Snack snack)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SnackId,SnackName,ShortDescription,LongDescription,Price,ImageUrl,ImageThumbUrl,IsFavorite,InStock,CategoryId")] Snack snack)
        {
            if (id != snack.SnackId)
            {
                return NotFound();
